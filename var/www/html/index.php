	...
	<body>
		...
		<main>
					...
					<?php
						...
						foreach ($homes as $home) {
							...
							if (is_dir("/home/$home/public_html")) {
								echo "<li><a href=\"//$home.gingras.family/\">$home</a></li>", PHP_EOL;
							}
						}
					?>
				</ul>
			...
			<section id="about">
				...
				<p>There's more to come in the future. Once I finish the shared web hosting configuration, I'm hoping to add a simple email service and maybe a database in the future to allow for full stack LAMP-style development. Lastly, I'm here to help. I want this to be a learning environment as well as a creative one. If you need additional help getting setup or finding out how to do something please reach out. Or, if you figure out something, let's turn it into a guide for everyone to benefit from. We can all invent a better internet together.</p>
			</section>
		</main>
	</body>
</html>
